            ...
            [
                new NavigationDomainViewModel
                {
                    ...
                    [
                        ...
                        Module("operations", "Sistema", "SI", "Informações do equipamento, manutenção administrativa e ações críticas do dispositivo.", "System", "Info", "sistema firmware rede tempo manutencao", "console", "primary", "Essencial", 3),
                        Module("operations", "Hardware", "HW", "GPIO, portas, biometria local e estado físico do equipamento.", "Hardware", "Status", "hardware gpio relay biometria portas", "console", "primary", "Operação", 4),
                        Module("operations", "Ações remotas", "AR", "Autorizações e comandos remotos com feedback imediato da operação.", "RemoteActions", "Index", "acoes remotas open door enroll message", "console", "primary", "Operação", 5),
                        Module("operations", "Catraca", "CT", "Eventos de giro, acionamentos e comandos dedicados para catracas.", "Catra", "Index", "catraca turnstile giro eventos", "console", "primary", "Operação", 6),
