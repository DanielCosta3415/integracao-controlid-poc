...
> **Documento vivo** · Público: usuários técnicos, desenvolvimento, QA e suporte · Responsável: engenharia de integração · Última validação: 2026-08-03.
...
O roteiro detalhado está em `troubleshooting-controlid.md` e os contratos em
