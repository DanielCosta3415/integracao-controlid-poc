...
> **Documento vivo** · Público: desenvolvimento, QA, SRE e FinOps · Responsável: engenharia de desempenho · Última validação: 2026-08-04.

Este documento governa medições reproduzíveis sem hardware. Ele complementa
`docs/finops-capacity.md`; números do simulador não representam limite de um
