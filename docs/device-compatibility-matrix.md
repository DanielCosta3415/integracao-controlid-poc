...
> **Documento vivo** · Público: avaliação, integração, produto e QA · Responsável: engenharia de integração · Última validação: 2026-08-03.
...
| Contingência | Equipamento | Equipamento | Dados locais atualizados antes da falha. | Observável por callbacks; procedimento em `equipment-contingency-runbook.md`. |
...
e `operation-modes-implementation.md`.
...
`reports/controlid-api-audit-2026-04-13.md`.
...
Use `reports/operation-modes-homologation-matrix-2026-04-14.md` como modelo
...
`official-api-version-governance.md`.
