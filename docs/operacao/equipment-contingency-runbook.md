...
> **Runbook** · Público: operação, suporte e SRE · Responsável: Plataforma/SRE · Última validação: 2026-08-12.
...
1. Classificar impacto e severidade no [docs/operacao/incident-response-and-dr.md](incident-response-and-dr.md).
