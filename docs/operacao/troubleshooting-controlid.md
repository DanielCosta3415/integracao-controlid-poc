...
> **Runbook** · Público: usuários, integração, suporte e SRE · Responsável: Plataforma/SRE · Última validação: 2026-08-12.
...
| Administrador perdeu a senha | Não há redefinição sem senha atual | Consultar [local-account-administration.md](../seguranca-privacidade/local-account-administration.md) | Preservar o banco e seguir recuperação aprovada; não editar hash diretamente. |
...
| HTTP não 2xx | Credencial, sessão, endpoint, licença ou carga útil recusada | Status e resposta minimizada | Consultar [api-error-catalog.md](../integracao-controlid/api-error-catalog.md) e a página oficial do endpoint. |
...
Consulte [push-implementation.md](../integracao-controlid/push-implementation.md) para estados, concorrência e segurança.
...
Siga [equipment-contingency-runbook.md](equipment-contingency-runbook.md) para continuidade física.
...
- Compare o modelo/firmware com [device-compatibility-matrix.md](../integracao-controlid/device-compatibility-matrix.md).
...
[incident-response-and-dr.md](incident-response-and-dr.md).
