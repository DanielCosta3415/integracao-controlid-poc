...
| --- | --- | --- | --- |
| Local | Existente | `launchSettings.json`, [README.md](../../README.md), `tools/smoke-localhost.ps1` | Usa `Development`, SQLite local e User Secrets/env vars. |
...
O fechamento das lacunas externas fica em [docs/operacao/residual-risk-closure.md](residual-risk-closure.md).

## Reversão técnica

Para incidentes ativos, use também [docs/operacao/incident-response-and-dr.md](incident-response-and-dr.md), que define
