...
> **Referência** · Público: manutenção, integração, QA e liberação · Responsável: Engenharia · Última validação: 2026-08-12.
...
8. Atualizar [device-compatibility-matrix.md](device-compatibility-matrix.md) e os documentos de contrato.
...
[reports/controlid-api-audit-2026-04-13.md](../historico/relatorios/controlid-api-audit-2026-04-13.md) e os relatórios de homologação de
