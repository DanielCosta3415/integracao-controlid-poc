...
e [push-implementation.md](push-implementation.md).
...
Para incidentes, siga [troubleshooting-controlid.md](../operacao/troubleshooting-controlid.md),
[equipment-contingency-runbook.md](../operacao/equipment-contingency-runbook.md) e [incident-response-and-dr.md](../operacao/incident-response-and-dr.md).
