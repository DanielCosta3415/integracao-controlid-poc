...
> **Referência** · Público: produto, integração, dados e operação · Responsável: Engenharia · Última validação: 2026-08-12.
...
- Direitos de titulares exigem localizar dados em equipamento, SQLite, logs e
  cópias de segurança, conforme [privacy-governance-runbook.md](../seguranca-privacidade/privacy-governance-runbook.md).
...
Consulte também [data-model-and-recovery.md](../dados/data-model-and-recovery.md), [privacy-and-data-retention.md](../seguranca-privacidade/privacy-and-data-retention.md) e
