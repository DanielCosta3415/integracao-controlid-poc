...
> **Referência** · Público: novos desenvolvedores · Responsável: Engenharia · Última validação: 2026-08-12.

Este guia leva um novo desenvolvedor do clone ao diagnóstico e entrega segura da
PoC. Ele complementa [README.md](../../README.md) e [AGENTS.md](../../AGENTS.md).
...
`Administrator`. Consulte [local-account-administration.md](../seguranca-privacidade/local-account-administration.md) e [faq.md](faq.md) antes de
...
1. Leia [AGENTS.md](../../AGENTS.md) e o documento de domínio afetado.
2. Localize arquivos pelo mapa [docs/arquitetura/project-file-responsibilities.md](../arquitetura/project-file-responsibilities.md).
...
| SQLite indisponível | `/health/ready`, permissão do arquivo, [docs/dados/data-model-and-recovery.md](../dados/data-model-and-recovery.md) |
...
| Chamada oficial Control iD | `Services/ControlIDApi/`, [docs/integracao-controlid/integration-contracts.md](../integracao-controlid/integration-contracts.md) |
...
| Docs/governança | `docs/`, [AGENTS.md](../../AGENTS.md), [README.md](../../README.md), `docs/adrs/` |
...
- [docs/seguranca-privacidade/privacy-and-data-retention.md](../seguranca-privacidade/privacy-and-data-retention.md)
- [docs/seguranca-privacidade/privacy-governance-runbook.md](../seguranca-privacidade/privacy-governance-runbook.md)
- [docs/dados/data-model-and-recovery.md](../dados/data-model-and-recovery.md)
