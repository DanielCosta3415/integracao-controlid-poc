...
> **Referência** · Público: primeiro contato, produto, integração e operação · Responsável: Engenharia · Última validação: 2026-08-12.
...
| --- | --- | --- | --- |
| Avaliador sem hardware | “O que a PoC demonstra?” | [README.md](../../README.md) e [faq.md](faq.md) | Fluxo com simulador concluído. |
| Desenvolvedor integrador | “Como chamar a Access API corretamente?” | [developer-onboarding.md](developer-onboarding.md) e [integration-contracts.md](../integracao-controlid/integration-contracts.md) | Contrato com simulador e testes aprovados. |
| Administrador de acesso | “Como cadastrar e operar identidades?” | [local-account-administration.md](../seguranca-privacidade/local-account-administration.md) e [data-synchronization-ownership.md](../integracao-controlid/data-synchronization-ownership.md) | Fluxo de usuário/regra entendido e ensaiado. |
| Infraestrutura/rede | “Quem precisa alcançar quem?” | [network-topologies.md](../integracao-controlid/network-topologies.md) | Matriz de fluxos e portas aprovada. |
| Segurança/DPO | “Quais dados e fronteiras precisam de controle?” | [security-hardening.md](../seguranca-privacidade/security-hardening.md) e [privacy-and-data-retention.md](../seguranca-privacidade/privacy-and-data-retention.md) | Controles e aprovações externas identificados. |
| QA/homologação | “O que está comprovado?” | [testing-strategy.md](../qualidade/testing-strategy.md) e [device-compatibility-matrix.md](../integracao-controlid/device-compatibility-matrix.md) | Evidência separa simulador de hardware. |
| Suporte/SRE | “Como diagnosticar sem vazar dados?” | [troubleshooting-controlid.md](../operacao/troubleshooting-controlid.md) | Incidente classificado e evidência segura. |
| Responsável por produção | “A solução pode ser liberada?” | [residual-risk-closure.md](../operacao/residual-risk-closure.md) e [deployment-runbook.md](../operacao/deployment-runbook.md) | Verificação estrita e aprovações avaliadas. |

## Avaliador sem equipamento físico

Objetivo: compreender valor e limites sem tocar um ambiente real.

1. Leia a visão geral e os limites no [README.md](../../README.md).
...
1. Identifique o fluxo em [product-acceptance-criteria.md](../produto/product-acceptance-criteria.md).
...
7. Atualize [integration-contracts.md](../integracao-controlid/integration-contracts.md) e a matriz de compatibilidade.
...
1. Desenhe os fluxos de [network-topologies.md](../integracao-controlid/network-topologies.md).
...
2. Selecione uma célula da [device-compatibility-matrix.md](../integracao-controlid/device-compatibility-matrix.md).
...
1. Classifique severidade em [incident-response-and-dr.md](../operacao/incident-response-and-dr.md).
...
4. Use [troubleshooting-controlid.md](../operacao/troubleshooting-controlid.md) e [api-error-catalog.md](../integracao-controlid/api-error-catalog.md).
...
Para perguntas pontuais, use [faq.md](faq.md); para detalhes de arquivos e comandos, use
[docs/README.md](../README.md) e [project-file-responsibilities.md](../arquitetura/project-file-responsibilities.md).
