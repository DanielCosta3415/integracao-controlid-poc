...
Para um percurso guiado por função, use [persona-guides.md](persona-guides.md). Para navegar por
toda a base técnica, use [README.md](../../README.md).
...
produtos Control iD. Os percursos por perfil estão em [persona-guides.md](persona-guides.md).
...
[residual-risk-closure.md](../operacao/residual-risk-closure.md).
...
[local-account-administration.md](../seguranca-privacidade/local-account-administration.md).
...
o procedimento de recuperação de [local-account-administration.md](../seguranca-privacidade/local-account-administration.md); não edite
...
em [developer-onboarding.md](developer-onboarding.md).
...
[network-topologies.md](../integracao-controlid/network-topologies.md).
...
[device-compatibility-matrix.md](../integracao-controlid/device-compatibility-matrix.md).
...
mudança oficial. O processo está em [official-api-version-governance.md](../integracao-controlid/official-api-version-governance.md).
...
[api-error-catalog.md](../integracao-controlid/api-error-catalog.md).
...
[operation-modes-implementation.md](../integracao-controlid/operation-modes-implementation.md) antes de escrever.
...
atualizados. Siga [equipment-contingency-runbook.md](../operacao/equipment-contingency-runbook.md).
...
[data-synchronization-ownership.md](../integracao-controlid/data-synchronization-ownership.md).
...
como réplica completa. Veja [data-synchronization-ownership.md](../integracao-controlid/data-synchronization-ownership.md).
...
[device-compatibility-matrix.md](../integracao-controlid/device-compatibility-matrix.md); uma ação incorreta pode retornar erro ou não
...
ou confirmação conforme [integration-contracts.md](../integracao-controlid/integration-contracts.md).
...
Use [troubleshooting-controlid.md](../operacao/troubleshooting-controlid.md): determine direção, valide health/session,
...
Use Docker/Compose ou o ambiente de execução .NET conforme [deployment-runbook.md](../operacao/deployment-runbook.md). Preserve
...
estão em [official-api-version-governance.md](../integracao-controlid/official-api-version-governance.md).
