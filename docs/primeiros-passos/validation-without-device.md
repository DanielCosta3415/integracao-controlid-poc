...
> **Referência** · Público: desenvolvimento, QA, produto e avaliação técnica · Responsável: Engenharia · Última validação: 2026-08-12.
...
[docs/integracao-controlid/endpoint-validation-matrix.md](../integracao-controlid/endpoint-validation-matrix.md) referencia execução em aparelho compatível,
