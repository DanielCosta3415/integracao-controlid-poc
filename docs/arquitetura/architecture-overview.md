...
> **Referência** · Público: desenvolvimento e arquitetura · Responsável: Engenharia · Última validação: 2026-08-12.
...
- Métricas e rótulos já documentados em [docs/operacao/observability-runbook.md](../operacao/observability-runbook.md).
...
- [docs/adrs/0001-local-sqlite-runtime-state.md](../adrs/0001-local-sqlite-runtime-state.md)
- [docs/adrs/0002-secure-controlid-ingress-and-egress.md](../adrs/0002-secure-controlid-ingress-and-egress.md)
- [docs/adrs/0003-in-process-observability-and-readiness-gates.md](../adrs/0003-in-process-observability-and-readiness-gates.md)
- [docs/adrs/0004-release-governance-with-local-scripts.md](../adrs/0004-release-governance-with-local-scripts.md)
