...
> **Referência** · Público: desenvolvimento e QA · Responsável: QA · Última validação: 2026-08-12.

Escopo: PoC ASP.NET Core MVC/Razor para integração com a Access API Control iD.
Esta estratégia complementa [docs/produto/product-acceptance-criteria.md](../produto/product-acceptance-criteria.md) e deve ser usada
...
| Homologação física | Equipamento real, firmware, rede e callbacks públicos | Evidências históricas em [relatórios](../historico/relatorios/README.md) e scripts `tools/contract-controlid-device.ps1` |
...
O inventário documental possui 81 arquivos Markdown: 80 documentos autorais e
uma licença vendorizada preservada por hash. As contagens são referências, não
metas: um teste novo precisa proteger comportamento ou risco.
