...
> **Runbook** · Público: DPO, jurídico e operação · Responsável: Segurança/Privacidade · Última validação: 2026-08-12.
...
| --- | --- | --- | --- | --- | --- |
| Usuários e credenciais | Necessita validação | [docs/seguranca-privacidade/privacy-and-data-retention.md](privacy-and-data-retention.md) | DPO/jurídico | Pendente | Pendente |
...
- Inventário de dados em [docs/seguranca-privacidade/privacy-and-data-retention.md](privacy-and-data-retention.md).
- Modelo de dados em [docs/dados/data-model-and-recovery.md](../dados/data-model-and-recovery.md).
- Fortalecimento em [docs/seguranca-privacidade/security-hardening.md](security-hardening.md).
