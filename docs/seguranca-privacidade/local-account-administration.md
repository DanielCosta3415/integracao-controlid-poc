...
> **Referência** · Público: usuários da PoC, administradores e suporte · Responsável: Segurança/Privacidade · Última validação: 2026-08-12.
...
3. restaure uma cópia anterior somente com aprovação humana e seguindo
   [data-model-and-recovery.md](../dados/data-model-and-recovery.md);
...
Consulte também [security-hardening.md](security-hardening.md), [privacy-and-data-retention.md](privacy-and-data-retention.md) e
[developer-onboarding.md](../primeiros-passos/developer-onboarding.md).
