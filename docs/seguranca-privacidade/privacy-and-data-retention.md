...
- Sem evidência de analytics externo, e-mail/SMS/push externo, gateway de pagamento, cache externo ou storage cloud de runtime. Analytics de produto existe apenas como métricas internas agregadas em `/metrics`, conforme [docs/produto/product-analytics.md](../produto/product-analytics.md).
...
- [docs/seguranca-privacidade/privacy-governance-runbook.md](privacy-governance-runbook.md) define RACI, DSAR, RIPD, DPA, retenção e incidente como artefatos verificáveis para decisão humana.
