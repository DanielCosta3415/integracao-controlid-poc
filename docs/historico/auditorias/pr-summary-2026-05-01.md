...
- Novo índice em [docs/README.md](../../README.md).
- Novo guia de onboarding em [docs/primeiros-passos/developer-onboarding.md](../../primeiros-passos/developer-onboarding.md).
- Nova visão de arquitetura em [docs/arquitetura/architecture-overview.md](../../arquitetura/architecture-overview.md).
- ADRs criados em `docs/adrs/`.
- Changelog e auditoria documental de 2026-05-01 adicionados.
- Fechamento de riscos residuais externos em [docs/operacao/residual-risk-closure.md](../../operacao/residual-risk-closure.md).
...
- Risco principal e documental: manter README, [docs/README.md](../../README.md) e ADRs
...
- Mudanças posteriores: consulte [docs/historico/changelogs/changelog-2026-08-03.md](../changelogs/changelog-2026-08-03.md).
- Validação atual: execute os comandos do [README.md](../../../README.md) e não reutilize resultados
