# Avaliação Heurística UX/UI - 14/04/2026
...
## Método
- Leitura do código-fonte das views, view models e CSS compartilhado
...
- Normalização da copy quebrada em view models e controladores diretamente ligados a essas telas.
- Ajustes globais no CSS para elevar telas ainda baseadas em containers/cards Bootstrap para um nível visual mais próximo do design system da PoC.

## Resultado esperado
- Menos sensação de “telas soltas” dentro do produto
