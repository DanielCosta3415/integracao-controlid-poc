...
> **Documento vivo** · Público: produto, integração, QA e release · Responsável: arquitetura de integrações · Última validação: 2026-08-04.
...
registrado em `docs/device-compatibility-matrix.md` e
`docs/residual-risk-closure.md`. A PoC está pronta para levar a execução até o
